  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-6 space-y-6">
      ...
      <section className="aspect-video w-full overflow-hidden rounded-2xl bg-black shadow-xl flex items-center justify-center">
        <div className="text-center text-neutral-200 space-y-2">
          <p className="text-sm font-medium">Dacast Player Placeholder</p>
          <p className="text-xs text-neutral-400">
            Dacast iframe/video player will be embedded here later.
          </p>
        </div>
      </section>
